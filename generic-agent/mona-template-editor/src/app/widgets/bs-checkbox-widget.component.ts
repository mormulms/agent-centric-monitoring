...
<div class="widget form-group">
  <label *ngIf="schema.title" [attr.for]="id" class="horizontal control-label">{{ schema.title }}</label>
...
export class BsCheckboxWidgetComponent extends ControlWidget implements AfterViewInit {
